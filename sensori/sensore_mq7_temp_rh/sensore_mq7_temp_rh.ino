...
const float Ro_clean_air_factor = 4.5;
...
// Connect a 20K resistor from pin 2 (data) to pin 1 (power) of the sensor
...
void setup() {
 ...
 // digitalWrite(pinNPN, HIGH);          ***commentato da me***
  // set = 200
  for(int i = 200; i>0; i--){
    blinkLED(pinGreenLED);
  }
//  digitalWrite(pinNPN, LOW);           ***commentato da me***
